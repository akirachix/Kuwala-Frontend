...
//       <div className="chart-container 2xl:h-[800px] 2xl:w-[900px] xl:h-[600px] xl:w-[600px] 2xl:pt-[6px]">
...
//       <div className="chart-container 2xl:h-[800px] 2xl:w-[900px] xl:h-[600px] xl:w-[600px] nest-hub:w-[400px] nest-hub-max:w-[400px] 2xl:pt-[8px]">
//         <Bar data={chartData} options={options} />
//       </div>
//     </div>
//   );
